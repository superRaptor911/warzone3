...
export const WEAPONS: Record<WeaponId, Weapon> = {
  pistol: {
    ...
    damage: 34, rpm: 340, mag: 12, reserve: 60, reloadMs: 1100,
  ...
  smg: {
    ...
    damage: 16, rpm: 820, mag: 32, reserve: 128, reloadMs: 1500,
  ...
  rifle: {
    ...
    damage: 26, rpm: 600, mag: 30, reserve: 120, reloadMs: 1800,
  ...
  shotgun: {
    ...
    damage: 13, rpm: 75, mag: 6, reserve: 36, reloadMs: 2400,
  ...
  sniper: {
    ...
    damage: 110, rpm: 42, mag: 5, reserve: 25, reloadMs: 2600,
